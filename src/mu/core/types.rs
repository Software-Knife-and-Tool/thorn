...
impl Tag {
    pub fn data(&self, mu: &Mu) -> u64 {
        ...
        match self {
            ...
            Tag::CDirect(tag) => tag.data(),
        }
    }

    pub fn as_slice(&self) -> [u8; 8] {
        match self {
            Tag::CDirect(tag) => tag.into_bytes(),
    ...
    pub fn from_slice(bits: &[u8]) -> Tag {
        ...
        match tag {
            ...
            tag if tag == TagType::CDirect as u8 => Tag::CDirect(CDirectTag::from(_u64)),
